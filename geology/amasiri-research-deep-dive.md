# Amasiri Sandstones — Technical Research Deep Dive
...
B.Sc. Geology Research Project

## Academic Context

Alex Ekwueme Federal University, Ndufu-Alike Ikwo · B.Sc. Geology · 2023
...
|---|---|
| Sample type | Sandstone |
| Number of samples | 6 |
| Porosity | Average of 39.63% |
| Permeability method | Constant-head method |
| Density analyses | Bulk density and particle density |
| Field positioning | GPS-supported |
| Structural work | Bedding attitudes and relevant structures |
...
- Sedimentary-structure observation
- Geological logging
...
The following original project materials can be added to this repository when available and suitable for public sharing:
...
[← Back to Geology & Research](./README.md)
